...
public class BitMEXTicker extends BitMEXResult {
  ...
  public BitMEXTicker(@JsonProperty("result") String result, @JsonProperty("error") String error, @JsonProperty("bid") BigDecimal bid,
  ...
  public String toString() {
    ...
    return "BitMEXTicker [" + "symbol=" + symbol + ", bid=" + bid + ", bidSize=" + bidSize + ", ask=" + ask + ", askSize=" + askSize
