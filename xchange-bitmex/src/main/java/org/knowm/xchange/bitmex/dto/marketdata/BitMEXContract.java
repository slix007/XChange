...
@Deprecated
public class BitMEXContract extends BitMEXResult {
  ...
  public BitMEXContract(@JsonProperty("result") String result, @JsonProperty("error") String error, @JsonProperty("unit") String unit,
  ...
  public String toString() {
    return "BitMEXContract [tradeable=" + tradeable + ", unit=" + unit + ", lastTradingDayAndTime="
