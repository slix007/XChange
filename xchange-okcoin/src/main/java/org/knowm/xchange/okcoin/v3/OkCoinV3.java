package org.knowm.xchange.okcoin.v3;
...
public interface OkCoinV3 {

//  @GET
//  @Path("futures/v3/instruments/ticker")
//  OkCoinTickerResponseV3 getTicker(@QueryParam("ok") String ok, @QueryParam("symbol") String symbol) throws IOException;

  @GET
  @Path("futures/v3/instruments/ticker")
  OkCoinTickerResponseV3 getFuturesTicker(@QueryParam("symbol") String symbol, @QueryParam("contract_type") String contract) throws IOException;
