...
public class BitMEXOpenOrder extends BitMEXResult {
  ...
  public BitMEXOpenOrder(@JsonProperty("result") String result, @JsonProperty("error") String error,
  ...
  public String toString() {
    return "BitMEXOpenOrder [uid=" + uid + ", timestamp=" + DATE_FORMAT.format(timestamp) + ", tradeable=" + tradeable + ", unit=" + unit
