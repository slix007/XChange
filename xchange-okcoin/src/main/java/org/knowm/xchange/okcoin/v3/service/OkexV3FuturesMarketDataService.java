...
public class OkexV3FuturesMarketDataService extends OkCoinMarketDataServiceRaw implements MarketDataService {
   ...
   * @param exchange
   */
  public OkexV3FuturesMarketDataService(Exchange exchange, FuturesContract futuresContract) {
