...
public class BitMEXInstrument extends BitMEXResult {
  ...
  public BitMEXInstrument(@JsonProperty("result") String result, @JsonProperty("error") String error,
  ...
  public String toString() {
    return "BitMEXInstrument [tradeable=" + tradeable + ", lastTradingTime="
